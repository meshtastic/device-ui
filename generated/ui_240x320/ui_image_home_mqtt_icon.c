...
#ifndef LV_ATTRIBUTE_IMG_HOME_MQTT_ICON
#define LV_ATTRIBUTE_IMG_HOME_MQTT_ICON
#endif

static const
LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_HOME_MQTT_ICON
uint8_t img_home_mqtt_icon_map[] = {
...
const lv_image_dsc_t img_home_mqtt_icon = {
  .header = {
  ...
  .data_size = sizeof(img_home_mqtt_icon_map),
  .data = img_home_mqtt_icon_map,
  .reserved = NULL,
};
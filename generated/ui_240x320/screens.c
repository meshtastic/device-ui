...
void create_screen_menu() {
    ...
    lv_obj_set_style_text_color(obj, lv_color_hex(0xffa6f0ff), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        ...
        }
        {
            ...
            lv_obj_set_size(obj, LV_PCT(100), LV_PCT(92));
            lv_obj_add_flag(obj, LV_OBJ_FLAG_SCROLL_ON_FOCUS|LV_OBJ_FLAG_IGNORE_LAYOUT);
            lv_obj_remove_flag(obj, LV_OBJ_FLAG_SCROLLABLE|LV_OBJ_FLAG_SNAPPABLE);
...
void create_screen_chats() {
    ...
    lv_obj_set_size(obj, 240, 320);
    {
        ...
        }
        {
            ...
            lv_obj_set_size(obj, LV_PCT(98), LV_PCT(16));
        ...
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_style_pad_right(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                ...
                }
                {
                    ...
                    lv_label_set_long_mode(obj, LV_LABEL_LONG_CLIP);
                    lv_obj_set_style_align(obj, LV_ALIGN_DEFAULT, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_label_set_text(obj, _("Time zone Berlin (GMT+1) "));
                }
            }
        }
        {
            ...
            lv_obj_set_style_pad_left(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_pad_right(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_text_font(obj, &ui_font_ds_digi_100_font, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                lv_obj_t *parent_obj = obj;
                {
                    // clockTimeLabel
...
ext_font_desc_t fonts[] = {
    { "DS_DIGI_100_FONT", &ui_font_ds_digi_100_font },

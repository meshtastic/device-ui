...
typedef struct _objects_t {
    ...
    lv_obj_t *obj1;
    lv_obj_t *obj2;
    lv_obj_t *obj2__chat_button;
    lv_obj_t *obj2__chat_channel_image;
    lv_obj_t *obj2__chat_id;
    lv_obj_t *obj2__chat_group_name;
    lv_obj_t *obj3;
    lv_obj_t *obj3__add_message_entry_button;
    lv_obj_t *obj3__add_message_entry_time_label;
    lv_obj_t *obj3__add_message_entry_text_label;
    lv_obj_t *obj4;
    lv_obj_t *obj4__new_message_entry_button;
    lv_obj_t *obj4__new_message_time_label;
    lv_obj_t *obj4__new_message_text_label;
    lv_obj_t *obj5;
    lv_obj_t *obj5__message_container;
    lv_obj_t *obj6;
    lv_obj_t *obj6__node_button;
    lv_obj_t *obj6__node_short_name;
    lv_obj_t *obj6__node_long_name;

...
typedef struct _objects_t {
    ...
    lv_obj_t *meshwork_mesh_detector_button;
    lv_obj_t *meshwork_mesh_detector_label;
    lv_obj_t *meshwork_neighbors_button;
    lv_obj_t *meshwork_neighbors_label;
    lv_obj_t *meshwork_signal_scanner_button;
    lv_obj_t *meshwork_signal_scanner_label;
    lv_obj_t *meshwork_trace_route_button;
    lv_obj_t *meshwork_trace_route_label;

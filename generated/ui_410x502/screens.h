...
typedef struct _objects_t {
    ...
    lv_obj_t *obj6;
    lv_obj_t *top_menu_panel;
    lv_obj_t *obj7;
    lv_obj_t *top_menu_label;
    lv_obj_t *bottom_menu_panel;
    lv_obj_t *menu_label;
    ...
    lv_obj_t *bottom_dashboard_panel;

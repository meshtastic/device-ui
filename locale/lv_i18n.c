...
static lv_i18n_phrase_t fi_singulars[] = {
    ...
    {"Cancel", "Peruuta"},
    {"FrequencySlot: %d (%.2f MHz)", "Taajuuspaikka: %d (%.2f MHz)"},
...
static lv_i18n_phrase_t nl_singulars[] = {
    ...
    {"OK", "OK"},
    {"Cancel", "Annuleer"},
    {"FrequencySlot: %d (%.2f MHz)", "FrequencySlot: %d (%.2f MHz)"},
...
static lv_i18n_phrase_t pl_singulars[] = {
    ...
    {"Default", "Domyślny"},
    {"Cancel", "Anuluj"},
    {"FrequencySlot: %d (%.2f MHz)", "Kanał: %d (%.2f MHz)"},
...
static lv_i18n_phrase_t pt_singulars[] = {
    ...
    {"OK", "OK"},
    {"Cancel", "Cancelar"},
    {"FrequencySlot: %d (%.2f MHz)", "Banco de Frequência %d (%.2f MHz)"},

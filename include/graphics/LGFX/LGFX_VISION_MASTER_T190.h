...
#define HELTEC_VTFT_LEDA 17
#define HELTEC_VTFT_CTRL 7

class LGFX_VISION_MASTER_T190 : public lgfx::LGFX_Device
{
    ...
    {
        {
            ...
            cfg.pin_sclk = 38;                 // Set SPI SCLK pin number
            cfg.pin_mosi = 48;                 // Set SPI MOSI pin number
            cfg.pin_miso = 4;                  // Set SPI MISO pin number (-1 = disable)
        ...
        {                                        // Set the display panel control.
            ...
            cfg.pin_cs = 39;   // Pin number where CS is connected (-1 = disable)
            cfg.pin_rst = 40;  // Pin number where RST is connected  (-1 = disable)
            ...
            cfg.offset_x = 35;              // Panel offset amount in X direction

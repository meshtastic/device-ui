...
{
  public:
    using DefaultPreset = meshtastic_Config_LoRaConfig_ModemPreset;
    ...
    static meshtastic_Config_LoRaConfig_ModemPreset getDefaultPreset(meshtastic_Config_LoRaConfig_RegionCode region);

 ...
 */
class TFTView_240x320 : public PluggableView
{
  public:
  ...
  private:
    ...
    static TFTView_240x320 *instance(void);
    static TFTView_240x320 *instance(const DisplayDriverConfig &cfg);
    TFTView_240x320();
    TFTView_240x320(const DisplayDriverConfig *cfg, DisplayDriver *driver);

 ...
 */
class TFTView_410x502 : public PluggableView
{
  public:
  ...
  private:
    ...
    static TFTView_410x502 *instance(void);
    static TFTView_410x502 *instance(const DisplayDriverConfig &cfg);
    TFTView_410x502();
    TFTView_410x502(const DisplayDriverConfig *cfg, DisplayDriver *driver);

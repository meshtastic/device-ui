  ...
  LGFX_HELTEC_TRACKER(void) {
    {
      ...
      cfg.spi_mode = 0;
      cfg.freq_write =
          40000000; // SPI clock for transmission (up to 80MHz, rounded to the
    ...
    { // Set the display panel control.
      ...
      cfg.offset_rotation =
          3; // Rotation direction value offset 0~7 (4~7 is upside down)
      cfg.dummy_read_pixel =
          8; // Number of bits for dummy read before pixel readout
      cfg.dummy_read_bits =
          1; // Number of bits for dummy read before non-pixel data read

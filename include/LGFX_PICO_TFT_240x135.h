...
#if 1 // got linker errors for pico when using standard framework and platform (because code is not included due to missing pico/stdio.h !?)
      // therefore included a dummy in pico folder

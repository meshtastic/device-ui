...
{
    if (!gui)
        gui = new OLEDView_128x64(DisplayDriverFactory::create(128, 64));
    return gui;
}
...
{
    if (!gui)
        gui = new OLEDView_128x64(DisplayDriverFactory::create(cfg));
    return gui;
}

OLEDView_128x64::OLEDView_128x64(DisplayDriver *driver) : MeshtasticView(driver, new OLEDViewController) {}

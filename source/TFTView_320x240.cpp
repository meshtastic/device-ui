...
#define CR_REPLACEMENT                                                         \
  0x0C // dummy to record several lines in a one line textarea
...
#ifdef USE_X11
TFTView_320x240::TFTView_320x240()
...
void TFTView_320x240::ui_set_active(lv_obj_t *b, lv_obj_t *p, lv_obj_t *tp) {
  ...
  // lv_obj_set_style_bg_img_recolor(b, lv_color_hex(0x67EA94), LV_PART_MAIN|
  // LV_STATE_DEFAULT);
...
void TFTView_320x240::ui_events_init(void) {
  ...
  // main button events
  lv_obj_add_event_cb(ui_HomeButton, ui_event_HomeButton, LV_EVENT_ALL,
                      this); // uses lambda above
  lv_obj_add_event_cb(ui_NodesButton, this->ui_event_NodesButton, LV_EVENT_ALL,
                      NULL);
  lv_obj_add_event_cb(ui_GroupsButton, this->ui_event_GroupsButton,
                      LV_EVENT_ALL, NULL);
  lv_obj_add_event_cb(ui_MessagesButton, this->ui_event_MessagesButton,
                      LV_EVENT_ALL, NULL);
  lv_obj_add_event_cb(ui_MapButton, this->ui_event_MapButton, LV_EVENT_ALL,
                      NULL);
  lv_obj_add_event_cb(ui_SettingsButton, this->ui_event_SettingsButton,
                      LV_EVENT_ALL, NULL);

  // node and channel buttons
  // TODO: node buttons are dynamic (implement array)
  lv_obj_add_event_cb(ui_NodeButton, ui_event_NodeButtonClicked, LV_EVENT_ALL,
                      ui_UserNameLabel);

  lv_obj_add_event_cb(ui_ChannelButton0, ui_event_ChannelButtonClicked,
                      LV_EVENT_ALL, ui_ChannelLabel0);
  lv_obj_add_event_cb(ui_ChannelButton1, ui_event_ChannelButtonClicked,
                      LV_EVENT_ALL, ui_ChannelLabel1);
  lv_obj_add_event_cb(ui_ChannelButton2, ui_event_ChannelButtonClicked,
                      LV_EVENT_ALL, ui_ChannelLabel2);
  lv_obj_add_event_cb(ui_ChannelButton3, ui_event_ChannelButtonClicked,
                      LV_EVENT_ALL, ui_ChannelLabel3);
  lv_obj_add_event_cb(ui_ChannelButton4, ui_event_ChannelButtonClicked,
                      LV_EVENT_ALL, ui_ChannelLabel4);
  lv_obj_add_event_cb(ui_ChannelButton5, ui_event_ChannelButtonClicked,
                      LV_EVENT_ALL, ui_ChannelLabel5);
  lv_obj_add_event_cb(ui_ChannelButton6, ui_event_ChannelButtonClicked,
                      LV_EVENT_ALL, ui_ChannelLabel6);
  lv_obj_add_event_cb(ui_ChannelButton7, ui_event_ChannelButtonClicked,
                      LV_EVENT_ALL, ui_ChannelLabel7);
...
void TFTView_320x240::ui_event_NodesButton(lv_event_t *e) {
  lv_event_code_t event_code = lv_event_get_code(e);
  if (event_code == LV_EVENT_CLICKED) {
    TFTView_320x240::instance()->ui_set_active(ui_NodesButton, ui_NodesPanel,
                                               ui_TopNodesPanel);
  }
}
...
void TFTView_320x240::ui_event_NodeButtonClicked(lv_event_t *e) {
  ...
  if (event_code == LV_EVENT_CLICKED) {
    ...
    TFTView_320x240::instance()->ui_set_active(
        ui_MessagesButton, ui_MessagesPanel, ui_TopMessagePanel);
  }
}
...
void TFTView_320x240::ui_event_GroupsButton(lv_event_t *e) {
  lv_event_code_t event_code = lv_event_get_code(e);
  if (event_code == LV_EVENT_CLICKED) {
    TFTView_320x240::instance()->ui_set_active(ui_GroupsButton, ui_GroupsPanel,
                                               ui_TopGroupsPanel);
  }
}
...
void TFTView_320x240::ui_event_ChannelButtonClicked(lv_event_t *e) {
  ...
  if (event_code == LV_EVENT_CLICKED) {
    ...
    TFTView_320x240::instance()->ui_set_active(
        ui_MessagesButton, ui_MessagesPanel, ui_TopGroupChatPanel);
  }
}
...
void TFTView_320x240::ui_event_MapButton(lv_event_t *e) {
  lv_event_code_t event_code = lv_event_get_code(e);
  if (event_code == LV_EVENT_CLICKED) {
    TFTView_320x240::instance()->ui_set_active(ui_MapButton, ui_MapPanel,
                                               ui_TopMapPanel);
  }
}
...
void TFTView_320x240::ui_event_SettingsButton(lv_event_t *e) {
  ...
  if (event_code == LV_EVENT_CLICKED) {
    TFTView_320x240::instance()->ui_set_active(
        ui_SettingsButton, ui_SettingsPanel, ui_TopSettingsPanel);
  }
}
...
void TFTView_320x240::addMessage(char *msg) {
  ...
  lv_obj_set_style_bg_color(hiddenPanel, lv_color_hex(0x303030),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_color(textLabel, lv_color_hex(0xF0F0F0),
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  // lv_obj_set_style_text_opa(textLabel, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_align(textLabel, LV_TEXT_ALIGN_LEFT,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_font(textLabel, &lv_font_montserrat_12,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_radius(textLabel, 10, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_color(textLabel, lv_color_hex(0x404040),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  // lv_obj_set_style_bg_opa(textLabel, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_color(textLabel, lv_color_hex(0x67EA94),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
...
void TFTView_320x240::addNode(uint32_t nodeNum, uint8_t channel,
  ...
  lv_obj_clear_flag(p, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_PRESS_LOCK |
  ...
  lv_obj_set_style_bg_color(p, lv_color_hex(0x404040),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(p, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_color(p, lv_color_hex(0x808080),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_bg_color(ui_NodeButton, lv_color_hex(0xFFFFFF),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_NodeButton, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_color(ui_NodeButton, lv_color_hex(0x000000),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_opa(ui_NodeButton, 0,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_NodeButton, 0,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_shadow_width(ui_NodeButton, 0,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_shadow_spread(ui_NodeButton, 0,
                                 LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_color(ln_lbl, lv_color_hex(0xF0F0F0),
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_opa(ln_lbl, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_font(ln_lbl, &lv_font_montserrat_12,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_color(sn_lbl, lv_color_hex(0xFFFFFF),
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_color(ui_BatteryLabel, lv_color_hex(0xF0F0F0),
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_opa(ui_BatteryLabel, 255,
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_align(ui_BatteryLabel, LV_TEXT_ALIGN_RIGHT,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_font(ui_BatteryLabel, &lv_font_montserrat_12,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_color(ui_lastHeardLabel, lv_color_hex(0xF0F0F0),
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_opa(ui_lastHeardLabel, 255,
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_align(ui_lastHeardLabel, LV_TEXT_ALIGN_RIGHT,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_font(ui_lastHeardLabel, &lv_font_montserrat_12,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_color(ui_SignalLabel, lv_color_hex(0xFFFFFF),
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_opa(ui_SignalLabel, 255,
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_font(ui_SignalLabel, &lv_font_montserrat_12,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  if (lastHeard) {
    ...
    while (i > 1) {
      if (lastHeard <=
          (time_t)(children[i - 1]->LV_OBJ_IDX(node_lh_idx)->user_data))
        break;
      i--;
    }
...
void TFTView_320x240::addOrUpdateNode(uint32_t nodeNum, uint8_t channel,
...
void TFTView_320x240::updateNode(uint32_t nodeNum, uint8_t channel,
                                 const char *userShort, const char *userLong,
                                 uint32_t lastHeard, eRole role) {
...
void TFTView_320x240::packetReceived(uint32_t from,
                                     const meshtastic_MeshPacket &p) {
  MeshtasticView::packetReceived(from, p);
}

void TFTView_320x240::updateChannelConfig(uint32_t index, const char *name,
...
void TFTView_320x240::setNodeImage(uint32_t nodeNum, eRole role,
  ...
  lv_obj_set_style_img_recolor(img, lv_color_hex(color),
                               LV_PART_MAIN | LV_STATE_DEFAULT);

...
TFTView_320x240::TFTView_320x240(const DisplayDriverConfig *cfg, DisplayDriver *driver)
    : MeshtasticView(cfg, driver, new ViewController), screensInitialised(false), nodesFiltered(0), processingFilter(false),
      ...
      db{} : MeshtasticView(cfg, driver, new ViewController),
 ...
 */
void TFTView_320x240::setupUIConfig(const meshtastic_DeviceUIConfig &uiconfig) void TFTView_320x240::setupUIConfig(
    const meshtastic_DeviceUIConfig &uiconfig)
{
...
void TDeckGUI::ui_event_HomeButton(lv_event_t * e) {
        ...
        ILOG_DEBUG("removing old route: %d %d %d", lv_obj_get_child_cnt(objects.trace_route_panel),
               ...
               if (currentPanel) {
                   THIS->setNodeImage(THIS->currentNode,
                                      (MeshtasticView::eRole)(unsigned long)currentPanel->LV_OBJ_IDX(node_img_idx)->user_data,
    ...
    void TFTView_320x240::ui_event_trace_route_node(lv_event_t * e)
    {
               ...
               void TFTView_320x240::packetDetected(const meshtastic_MeshPacket &p)
               {
                   ...
                   if (heard) {
                       if (p.to == ownNode && p.decoded.portnum == meshtastic_PortNum_NODEINFO_APP) {
                           ...
                           setNodeImage(p.from,
                                        (MeshtasticView::eRole)(unsigned long)nodes[p.from]->LV_OBJ_IDX(node_img_idx)->user_data,
               ...
               void TFTView_320x240::writePacketLog(const meshtastic_MeshPacket &p)
               {
                   static std::unordered_map<uint16_t, const char *> name = {
                       {0, "unknown"},        {1, "text message"}, {2, "remote hardware"},
                       {3, "position"},       {4, "node info"},    {5, "routing"},
                       {6, "admin"},          {7, "text message"}, {8, "waypoint"},
                       {9, "audio"},          {10, "sensor"},      {32, "reply"},
                       {33, "ip tunnel"},     {34, "paxcounter"},  {64, "serial"},
                       {65, "store forward"}, {66, "range test"},  {67, "telemetry"},
                       {68, "ZPS"},           {69, "simulator"},   {70, "tracert"},
                       {71, "neighbor info"}, {72, "atax"},        {73, "map report"},
               ...
               void TFTView_320x240::updateStatistics(const meshtastic_MeshPacket &p)
               {
                                           ...
                                           uint32_t TFTView_320x240::language2val(meshtastic_Language lang)
                                           {
                                               ...
                                               meshtastic_Language TFTView_320x240::val2language(uint32_t val)
                                               {
                                                   ...
                                                   void TFTView_320x240::setLanguage(meshtastic_Language lang)
                                                   {
                                                       ...
                                                       lv_dropdown_set_selected(objects.settings_language_dropdown,
                                                                                language2val(lang));
                                                       lv_dropdown_get_selected_str(objects.settings_language_dropdown, buf1,
                                                                                    sizeof(buf1));
                                                   ...
                                                   {
                                                       char buf[32];
                                                       lv_snprintf(buf, sizeof(buf), _("Screen Brightness: %d%%"),
                                                                   uint16_t(round((brightness * 100) / 255.0)));
                                                   ...
                                                   void TFTView_320x240::setTheme(uint32_t value)
                                                   {
                                                       ...
                                                       lv_dropdown_get_selected_str(objects.settings_theme_dropdown, buf1,
                                                                                    sizeof(buf1));
                                                   ...
                                                   void TFTView_320x240::storeNodeOptions(void)
                                                   {
                                                       ...
                                                       filter.unknown_switch = lv_obj_has_state(
                                                           objects.nodes_filter_unknown_switch, LV_STATE_CHECKED);
                                                       filter.offline_switch = lv_obj_has_state(
                                                           objects.nodes_filter_offline_switch, LV_STATE_CHECKED);
                                                       filter.public_key_switch = lv_obj_has_state(
                                                           objects.nodes_filter_public_key_switch, LV_STATE_CHECKED);
                                                       filter.hops_away =
                                                           lv_dropdown_get_selected(objects.nodes_filter_hops_dropdown);
                                                       // filter.mqtt_switch = lv_obj_has_state(objects.nodes_filter_mqtt_switch,
                                                       // LV_STATE_CHECKED); filter.mqtt_switch =
                                                       // lv_obj_has_state(objects.nodes_filter_mqtt_switch, LV_STATE_CHECKED);
                                                       filter.position_switch = lv_obj_has_state(
                                                           objects.nodes_filter_position_switch, LV_STATE_CHECKED);
                                                       strncpy(filter.node_name,
                                                               lv_textarea_get_text(objects.nodes_filter_name_area),
                                                               sizeof(filter.node_name));

                                                       // store node highlight options
                                                       meshtastic_NodeHighlight &highlight = db.uiConfig.node_highlight;
                                                       db.uiConfig.has_node_highlight = true;
                                                       highlight.chat_switch = lv_obj_has_state(
                                                           objects.nodes_hl_active_chat_switch, LV_STATE_CHECKED);
                                                       highlight.position_switch =
                                                           lv_obj_has_state(objects.nodes_hl_position_switch, LV_STATE_CHECKED);
                                                       highlight.telemetry_switch =
                                                           lv_obj_has_state(objects.nodes_hl_telemetry_switch, LV_STATE_CHECKED);
                                                       highlight.iaq_switch =
                                                           lv_obj_has_state(objects.nodes_hliaq_switch, LV_STATE_CHECKED);
                                                       strncpy(highlight.node_name,
                                                               lv_textarea_get_text(objects.nodes_hl_name_area),
                                                               sizeof(highlight.node_name));
                                                       ...
                                                       if (event_code == LV_EVENT_CLICKED) {
                                                           ...
                                                           case eUsername: {
                                                               ...
                                                               const char *userShort =
                                                                   lv_textarea_get_text(objects.settings_user_short_textarea);
                                                               const char *userLong =
                                                               ...
                                                               THIS->notifyReboot(true);
                                                               lv_obj_add_flag(objects.settings_username_panel,
                                                                               LV_OBJ_FLAG_HIDDEN);
                                                           ...
                                                           case eDeviceRole: {
                                                               ...
                                                               meshtastic_Config_DeviceConfig_Role role =
                                                                   (meshtastic_Config_DeviceConfig_Role)lv_dropdown_get_selected(
                                                                       objects.settings_device_role_dropdown);
                                                               meshtastic_Config_DeviceConfig_Role role =
                                                                   (meshtastic_Config_DeviceConfig_Role)lv_dropdown_get_selected(
                                                                       objects.settings_device_role_dropdown);
                                                               ...
                                                               if (role != device.role) {
                                                                   ...
                                                                   lv_dropdown_get_selected_str(
                                                                       objects.settings_device_role_dropdown, buf1, sizeof(buf1));
                                                                   ...
                                                                   THIS->controller->sendConfig(
                                                                       meshtastic_Config_DeviceConfig{device}, THIS->ownNode);
                                                                   THIS->notifyReboot(true);
                                                               }
                                                           ...
                                                           case eRegion: {
                                                               meshtastic_Config_LoRaConfig_RegionCode region =
                                                                   (meshtastic_Config_LoRaConfig_RegionCode)(lv_dropdown_get_selected(
                                                                                                                 objects
                                                                                                                     .settings_region_dropdown) +
                                                                                                             1);

                                                               uint32_t numChannels = LoRaPresets::getNumChannels(
                                                                   region, THIS->db.config.lora.modem_preset);
                                                               if (numChannels == 0) {
                                                                   // region not possible for selected preset, revert
                                                                   lv_dropdown_set_selected(objects.settings_region_dropdown,
                                                                                            THIS->db.config.lora.region - 1);
                                                                   return;
                                                               }

                                                               if (region != THIS->db.config.lora.region) {
                                                                   char buf1[10], buf2[30];
                                                                   lv_dropdown_get_selected_str(objects.settings_region_dropdown,
                                                                                                buf1, sizeof(buf1));
                                                                   lv_snprintf(buf2, sizeof(buf2), _("Region: %s"), buf1);
                                                                   lv_label_set_text(objects.basic_settings_region_label, buf2);

                                                                   meshtastic_Config_LoRaConfig &lora = THIS->db.config.lora;
                                                                   uint32_t defaultSlot = LoRaPresets::getDefaultSlot(
                                                                       region, THIS->db.config.lora.modem_preset);
                                                                   lora.region = region;
                                                                   lora.channel_num =
                                                                       (defaultSlot <= numChannels ? defaultSlot : 1);
                                                                   THIS->controller->sendConfig(
                                                                       meshtastic_Config_LoRaConfig{lora}, THIS->ownNode);
                                                                   THIS->notifyReboot(true);
                                                               }
                                                           ...
                                                           case eModemPreset: {
                                                               ...
                                                               meshtastic_Config_LoRaConfig_ModemPreset preset =
                                                                   (meshtastic_Config_LoRaConfig_ModemPreset)(lv_dropdown_get_selected(
                                                                       objects.settings_modem_preset_dropdown));
                                                               uint16_t channelNum =
                                                                   lv_slider_get_value(objects.frequency_slot_slider);
                                                               if (preset != lora.modem_preset ||
                                                                   lora.channel_num != channelNum) {
                                                                   char buf1[16], buf2[32];
                                                                   lv_dropdown_get_selected_str(
                                                                       objects.settings_modem_preset_dropdown, buf1,
                                                                       sizeof(buf1));
                                                                   lv_snprintf(buf2, sizeof(buf2), _("Modem Preset: %s"), buf1);
                                                                   lv_label_set_text(objects.basic_settings_modem_preset_label,
                                                                                     buf2);
                                                               ...
                                                               lv_obj_add_flag(objects.settings_modem_preset_panel,
                                                                               LV_OBJ_FLAG_HIDDEN);
                                                           ...
                                                           case eChannel: {
                                                               for (int i = 0; i < c_max_channels; i++) {
                                                                   ...
                                                                   if (memcmp(&THIS->db.channel[i], &THIS->channel_scratch[i],
                                                                              sizeof(THIS->channel_scratch[i])) != 0) {
                                                                       THIS->channel_scratch[i].has_settings = true;
                                                                       THIS->updateChannelConfig(THIS->channel_scratch[i]);
                                                                       THIS->controller->sendConfig(THIS->channel_scratch[i],
                                                                                                    THIS->ownNode);
                                                                   }
                                                               }
                                                               ...
                                                               char buf[32];
                                                               lv_snprintf(buf, sizeof(buf), _("Channel: %s"),
                                                                           THIS->db.channel[ch].settings.name);
                                                               lv_label_set_text(objects.basic_settings_channel_label, buf);

                                                               lv_obj_clear_state(objects.settings_channel_panel,
                                                                                  LV_STATE_DISABLED);
                                                               lv_obj_add_flag(objects.settings_channel_panel,
                                                                               LV_OBJ_FLAG_HIDDEN);
                                                           ...
                                                           case eWifi: {
                                                               char buf[30];
                                                               const char *ssid =
                                                                   lv_textarea_get_text(objects.settings_wifi_ssid_textarea);
                                                               const char *psk =
                                                                   lv_textarea_get_text(objects.settings_wifi_password_textarea);
                                                               lv_snprintf(buf, sizeof(buf), _("WiFi: %s"),
                                                                           ssid[0] ? ssid : _("<not set>"));
                                                               ...
                                                               if (strcmp(THIS->db.config.network.wifi_ssid, ssid) != 0 ||
                                                                   ...
                                                                   THIS->controller->sendConfig(
                                                                       meshtastic_Config_NetworkConfig{THIS->db.config.network},
                                                                       THIS->ownNode);
                                                                   THIS->notifyReboot(true);
                                                               }
                                                           ...
                                                           case eLanguage: {
                                                               uint32_t value =
                                                                   lv_dropdown_get_selected(objects.settings_language_dropdown);
                                                               ...
                                                               lv_obj_add_flag(objects.settings_language_panel,
                                                                               LV_OBJ_FLAG_HIDDEN);
                                                           ...
                                                           case eScreenTimeout: {
                                                               uint32_t value =
                                                                   lv_slider_get_value(objects.screen_timeout_slider);
                                                               if (value > 5)
                                                                   value -= value % 5;
                                                               ...
                                                               lv_obj_add_flag(objects.settings_screen_timeout_panel,
                                                                               LV_OBJ_FLAG_HIDDEN);
                                                               lv_group_focus_obj(objects.basic_settings_timeout_button);
                                                               break;
                                                           }
                                                           case eScreenLock: {
                                                               const char *pin = lv_textarea_get_text(
                                                                   objects.settings_screen_lock_password_textarea);
                                                               bool screenLock = lv_obj_has_state(
                                                                   objects.settings_screen_lock_switch, LV_STATE_CHECKED);
                                                               bool settingsLock = lv_obj_has_state(
                                                                   objects.settings_settings_lock_switch, LV_STATE_CHECKED);
                                                               if ((screenLock || settingsLock) &&
                                                                   (atol(pin) == 0 || strlen(pin) != 6))
                                                                   return; // require pin != "000000"
                                                               if ((screenLock != THIS->db.uiConfig.screen_lock) ||
                                                                   settingsLock != THIS->db.uiConfig.settings_lock ||
                ...
                break;
                                                           ...
                                                           case eScreenBrightness: {
                                                               int32_t value =
                                                                   lv_slider_get_value(objects.brightness_slider) * 255 / 100;
                                                               if (value != THIS->db.uiConfig.screen_brightness) {
                THIS->setBrightness(value);
                THIS->db.uiConfig.screen_brightness = value;
                THIS->controller->storeUIConfig(THIS->db.uiConfig);
                                                               }
                                                               lv_obj_add_flag(objects.settings_brightness_panel,
                                                                               LV_OBJ_FLAG_HIDDEN);
                                                           ...
                                                           case eTheme: {
                                                               uint32_t value =
                                                                   lv_dropdown_get_selected(objects.settings_theme_dropdown);
                ...
                lv_obj_set_style_bg_img_recolor(objects.settings_button, lv_color_hex(0x67EA94), LV_PART_MAIN | LV_STATE_DEFAULT);
                                                           ...
                                                           case eInputControl: {
                                                               ...
                                                               lv_dropdown_get_selected_str(
                                                                   objects.settings_keyboard_input_dropdown, new_val_kbd,
                                                                   sizeof(new_val_kbd));
                                                               lv_dropdown_get_selected_str(objects.settings_mouse_input_dropdown,
                                                                                            new_val_ptr, sizeof(new_val_ptr));
                ...
                return;
                                                               ...
                                                               std::string current_kbd =
                                                                   THIS->inputdriver->getCurrentKeyboardDevice();
                                                               std::string current_ptr =
                                                                   THIS->inputdriver->getCurrentPointerDevice();
                                                               if (strcmp(current_kbd.c_str(), _("none")) == 0 &&
                                                                   strcmp(current_ptr.c_str(), _("none")) == 0 &&
                                                                   THIS->input_group) {
                lv_group_delete(THIS->input_group);
                THIS->input_group = nullptr;
                                                               } else if (strcmp(THIS->old_val1_scratch, current_kbd.c_str()) !=
                                                                              0 ||
                                                                          strcmp(THIS->old_val2_scratch, current_ptr.c_str()) !=
                                                                              0) {
                THIS->setInputGroup();
                                                               }

                                                               lv_obj_add_flag(objects.settings_input_control_panel,
                                                                               LV_OBJ_FLAG_HIDDEN);
                                                           ...
                                                           case eAlertBuzzer: {
                                                               meshtastic_ModuleConfig_ExternalNotificationConfig &config =
                                                                   THIS->db.module_config.external_notification;
                                                               int tone =
                                                                   lv_dropdown_get_selected(objects.settings_ringtone_dropdown) +
                                                                   1;

                                                               bool silent = false;
                                                               bool alert_message = lv_obj_has_state(
                                                                   objects.settings_alert_buzzer_switch, LV_STATE_CHECKED);
                                                               if ((!config.enabled || !config.alert_message_buzzer) &&
                                                                   alert_message) {
                ...
                silent = true;
                                                               ...
                                                               THIS->controller->sendConfig(ringtone[silent ? 0 : tone].rtttl,
                                                                                            THIS->ownNode);
                                                               ...
                                                               lv_obj_add_flag(objects.settings_alert_buzzer_panel,
                                                                               LV_OBJ_FLAG_HIDDEN);
                                                           ...
                                                           case eReset: {
                                                               uint32_t option =
                                                                   lv_dropdown_get_selected(objects.settings_reset_dropdown);
                                                               THIS->notifyReboot(true);
                                                           ...
                                                           case eModifyChannel: {
                                                               ...
                                                               const char *name = lv_textarea_get_text(
                                                                   objects.settings_modify_channel_name_textarea);
                                                               const char *base64 = lv_textarea_get_text(
                                                                   objects.settings_modify_channel_psk_textarea);
                                                               uint8_t btn_id =
                                                                   (unsigned long)
                                                                       objects.settings_modify_channel_name_textarea->user_data;
                                                               int8_t ch = (signed long)THIS->ch_label[btn_id]->user_data;
                ...
                break;
                                                       ...
                                                       void TFTView_320x240::ui_event_brightness_slider(lv_event_t * e)
                                                       {
                                                           lv_obj_t *slider = lv_event_get_target_obj(e);
                                                           char buf[20];
                                                           lv_snprintf(buf, sizeof(buf), _("Brightness: %d%%"),
                                                                       (int)lv_slider_get_value(slider));
                                                           lv_label_set_text(objects.settings_brightness_label, buf);
                                                           THIS->displaydriver->setBrightness(
                                                               (uint8_t)(lv_slider_get_value(slider) * 255 / 100));
                                                       }
                                                       ...
                                                       void TFTView_320x240::ui_event_modem_preset_dropdown(lv_event_t * e)
                                                       {
                                                           ...
                                                           uint32_t numChannels =
                                                               LoRaPresets::getNumChannels(THIS->db.config.lora.region, preset);
                                                           if (preset ==
                                                               ...
                                                               numChannels =
                                                                   LoRaPresets::getNumChannels(THIS->db.config.lora.region,
                                                                                               THIS->db.config.lora.modem_preset);
                                                               return;
                                                           }

                                                           uint32_t channel =
                                                               LoRaPresets::getDefaultSlot(THIS->db.config.lora.region, preset);
                                                           if (channel > numChannels)
                                                               channel = 1;
                                                           lv_slider_set_range(objects.frequency_slot_slider, 1, numChannels);
                                                           lv_slider_set_value(objects.frequency_slot_slider, channel,
                                                                               LV_ANIM_ON);

                                                           char buf[40];
                                                           sprintf(buf, _("FrequencySlot: %d (%g MHz)"), channel,
                                                                   LoRaPresets::getRadioFreq(THIS->db.config.lora.region, preset,
                                                                                             channel));
                                                           lv_label_set_text(objects.frequency_slot_label, buf);
                                                       }
                                                        ...
                                                        *        First a panel is created where the widget is located in, then the
                                                        * widget is drawn. "active_widget" contains the surrounding panel which
                                                        * must be destroyed to remove the widget from the screen (e.g. by pressing
                                                        * OK/Cancel).
                                                        *
                                                        * @param func
                                                        */
                                                       ...
                                                       void TFTView_320x240::handleAddMessage(char *msg)
                                                       {
                                                           ...
                                                           if (channelOrNode < c_max_channels) {
                                                               ...
                                                               requestId =
                                                                   requests.addRequest(ch, ResponseHandler::TextMessageRequest);
                                                           } else {
                                                               ch = (uint8_t)(unsigned long)nodes[channelOrNode]->user_data;
                                                               to = channelOrNode;
                                                               requestId = requests.addRequest(
                                                                   to, ResponseHandler::TextMessageRequest, (void *)to);
                                                               // trial: hoplimit optimization for direct text messages
                                                               int8_t hopsAway = (signed long)nodes[channelOrNode]
                                                                                     ->LV_OBJ_IDX(node_sig_idx)
                                                                                     ->user_data;
                                                               if (hopsAway < 0)
                hopsAway = db.config.lora.hop_limit;
                                                               hopLimit = (hopsAway < db.config.lora.hop_limit ? hopsAway + 1
                                                                                                               : hopsAway);
                                                           }
                                                       ...
                                                       void TFTView_320x240::addMessage(uint32_t requestId, char *msg)
                                                       {
                                                           ...
                                                           lv_obj_set_style_radius(hiddenPanel, 0,
                                                                                   LV_PART_MAIN | LV_STATE_DEFAULT);
                                                           add_style_panel_style(hiddenPanel);

                                                           lv_obj_set_style_border_width(hiddenPanel, 0,
                                                                                         LV_PART_MAIN | LV_STATE_DEFAULT);
                                                           lv_obj_set_style_pad_left(hiddenPanel, 0,
                                                                                     LV_PART_MAIN | LV_STATE_DEFAULT);
                                                           lv_obj_set_style_pad_right(hiddenPanel, 0,
                                                                                      LV_PART_MAIN | LV_STATE_DEFAULT);
                                                           lv_obj_set_style_pad_top(hiddenPanel, 0,
                                                                                    LV_PART_MAIN | LV_STATE_DEFAULT);
                                                           lv_obj_set_style_pad_bottom(hiddenPanel, 0,
                                                                                       LV_PART_MAIN | LV_STATE_DEFAULT);
                                                           ...
                                                           lv_coord_t width =
                                                               lv_txt_get_width(msg, strlen(msg), &ui_font_montserrat_12, 0);
                                                           lv_obj_set_width(
                                                               textLabel,
                                                               std::max<int32_t>(std::min<int32_t>(width + 20, 200), 40));
                ...
                msg[i] = '\n';
                                                       ...
                                                       void TFTView_320x240::addNode(uint32_t nodeNum, uint8_t ch,
                                                                                     const char *userShort, const char *userLong,
                                                                                     uint32_t lastHeard, eRole role, bool hasKey,
                                                                                     bool viaMqtt)
                                                       {
    ...
    while (nodeCount >= MAX_NUM_NODES_VIEW) {
        purgeNode();
                                                           ...
                                                           lv_obj_remove_flag(
                                                               p, lv_obj_flag_t(LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_PRESS_LOCK |
                                                           ...
                                                           if (!hasKey) {
                                                               lv_obj_set_style_border_color(img, lv_color_hex(0xffff5555),
                                                                                             LV_PART_MAIN | LV_STATE_DEFAULT);
                                                           }
                                                           ...
                                                           lv_obj_set_style_shadow_width(nodeButton, 0,
                                                                                         LV_PART_MAIN | LV_STATE_DEFAULT);
                                                           lv_obj_set_style_max_height(nodeButton, 132,
                                                                                       LV_PART_MAIN | LV_STATE_DEFAULT);
                                                           lv_obj_set_style_min_height(nodeButton, 50,
                                                                                       LV_PART_MAIN | LV_STATE_DEFAULT);
                                                           ...
                                                           // TODO: devices without actual time will report all nodes as lastseen
                                                           // = now
                                                           if (lastHeard) {
                                                               time_t curtime;
                                                               time(&curtime);
                                                               lastHeard =
                                                                   std::min(curtime, (time_t)lastHeard); // adapt values too large
                ...
                nodesOnline++;
                                                           ...
                                                           ui_SignalLabel->user_data = (void *)-1; // TODO viaMqtt; // used for
                                                                                                   // filtering (applyNodesFilter)
                                                           // PositionLabel
                                                           ...
                                                           lv_obj_set_style_align(ui_PositionLabel, LV_ALIGN_TOP_LEFT,
                                                                                  LV_PART_MAIN | LV_STATE_DEFAULT);
                                                           lv_obj_set_style_text_color(ui_PositionLabel, lv_color_hex(0xff05f6cb),
                                                                                       LV_PART_MAIN | LV_STATE_DEFAULT);
                                                           ...
                                                           lv_obj_add_event_cb(nodeButton, ui_event_NodeButton, LV_EVENT_ALL,
                                                                               (void *)nodeNum);
                ...
                _lv_ll_move_before(lv_group_ll, nodeButton->user_data, after);
                                                       ...
                                                       void TFTView_320x240::setDeviceMetaData(int hw_model, const char *version,
                                                                                               bool has_bluetooth, bool has_wifi,
                                                                                               bool has_eth, bool can_shutdown)
                                                       {
                                                       }

                                                       void TFTView_320x240::addOrUpdateNode(
                                                           uint32_t nodeNum, uint8_t ch, const char *userShort,
                                                           const char *userLong, uint32_t lastHeard, eRole role, bool hasKey,
                                                           bool viaMqtt)
                                                       {
                                                           if (nodes.find(nodeNum) == nodes.end()) {
                                                               addNode(nodeNum, ch, userShort, userLong, lastHeard, role, hasKey,
                                                                       viaMqtt);
                                                           } else {
                                                        ...
                                                        * @param viaMqtt
                                                        */
                                                       void TFTView_320x240::updateNode(uint32_t nodeNum, uint8_t ch,
                                                                                        const char *userShort,
                ...
                db.config.device.role = (meshtastic_Config_DeviceConfig_Role)role;
                                                               ...
                                                               it->second->LV_OBJ_IDX(node_lbl_idx)->user_data =
                                                                   (void *)strlen(userLong);
                                                               lv_label_set_text(it->second->LV_OBJ_IDX(node_lbs_idx), userShort);
                                                               char *userData =
                                                                   (char *)&(it->second->LV_OBJ_IDX(node_lbs_idx)->user_data);
                                                               userData[0] = userShort[0];
                                                               if (userData[0] == 0x00)
                userData[0] = ' ';
                                                               userData[1] = userShort[1];
                ...
                userData[0] = ' ';
                                                               ...
                                                               setNodeImage(nodeNum, role, viaMqtt,
                ...
                lv_obj_set_style_border_color(it->second->LV_OBJ_IDX(node_img_idx), lv_color_hex(0xffff5555),
                                              LV_PART_MAIN | LV_STATE_DEFAULT);
                                                       ...
                                                       void TFTView_320x240::updatePosition(uint32_t nodeNum, int32_t lat,
                                                                                            int32_t lon, int32_t alt,
                                                                                            uint32_t sats, uint32_t precision)
                                                       {
                                                           if (nodeNum == ownNode) {
                                                               char buf[64];
                ...
                sprintf(buf, "%dm MSL  %u sats", abs(alt) < 10000 ? alt : 0, sats);
                                                               ...
                                                               // store lat/lon in user_data, because we need these values later
                                                               // to calculate the distance to us
                                                       ...
                                                       void TFTView_320x240::updateDistance(uint32_t nodeNum, int32_t lat,
                                                                                            int32_t lon)
                                                       {
                                                           // if we know our position then calculate (simple) distance to other
                                                           // node in km
                                                           ...
                                                           char buf[32];
                                                           char *userData =
                                                               (char *)&(nodes[nodeNum]->LV_OBJ_IDX(node_lbs_idx)->user_data);
                                                           buf[0] = userData[0];
                                                           buf[1] = userData[1];
                                                           buf[2] = userData[2];
                                                           buf[3] = userData[3];
                                                           ...
                                                           // we used the userShort label to add the distance, so re-arrange a bit
                                                           // the position
                                                        ...
                                                        * @param airUtil
                                                        */
                                                       void TFTView_320x240::updateMetrics(uint32_t nodeNum, uint32_t bat_level,
                                                                                           float voltage, float chUtil,
                                                                                           float airUtil)
                                                       {
                                                           auto it = nodes.find(nodeNum);
                                                           if (it != nodes.end()) {
                ...
                lv_label_set_text(it->second->LV_OBJ_IDX(node_bat_idx), buf);
                                                       ...
                                                       void TFTView_320x240::updateEnvironmentMetrics(
                                                           uint32_t nodeNum, const meshtastic_EnvironmentMetrics &metrics)
                                                       {
                                                           auto it = nodes.find(nodeNum);
                                                           if (it != nodes.end()) {
                                                               char buf[50];
                ...
                it->second->LV_OBJ_IDX(node_tm2_idx)->user_data = (void *)(uint32_t)metrics.iaq;
                                                       ...
                                                       void TFTView_320x240::updateAirQualityMetrics(
                                                           uint32_t nodeNum, const meshtastic_AirQualityMetrics &metrics)
                                                       {
                                                           auto it = nodes.find(nodeNum);
                                                           if (it != nodes.end() && it->first != ownNode) {
                                                               // TODO
                                                               // char buf[32];
                                                               // sprintf(buf, "%d %d", metrics.particles_03um,
                                                               // metrics.pm100_environmental);
                                                               // lv_label_set_text(it->second->LV_OBJ_IDX(node_tm2_idx), buf);
                                                           }
                                                       }

                                                       void TFTView_320x240::updatePowerMetrics(
                                                           uint32_t nodeNum, const meshtastic_PowerMetrics &metrics)
                                                       {
                                                           auto it = nodes.find(nodeNum);
                                                           if (it != nodes.end() && it->first != ownNode) {
                                                               // TODO
                                                               // char buf[32];
                                                               // sprintf(buf, "%0.1fmA %0.2fV", metrics.ch1_current,
                                                               // metrics.ch1_voltage);
                                                               // lv_label_set_text(it->second->LV_OBJ_IDX(node_tm2_idx), buf);
                                                           }
                                                       }

                                                       void TFTView_320x240::updateSignalStrength(uint32_t nodeNum, int32_t rssi,
                                                                                                  float snr)
                                                       {
                                                           if (nodeNum != ownNode) {
                                                               auto it = nodes.find(nodeNum);
                ...
                it->second->LV_OBJ_IDX(node_sig_idx)->user_data = (void *)(unsigned long)hopsAway;
                                                       ...
                                                       void TFTView_320x240::updateConnectionStatus(
                                                           const meshtastic_DeviceConnectionStatus &status)
                                                       {
                                                           if (status.has_wifi) {
                                                               if (db.config.network.wifi_enabled ||
                                                                   db.config.network.eth_enabled) {
                ...
                lv_obj_set_style_text_color(objects.home_ethernet_label, lv_color_hex(0x808080), LV_PART_MAIN | LV_STATE_DEFAULT);
                                                        ...
                                                        */
                                                       void TFTView_320x240::handleResponse(uint32_t from, const uint32_t id,
                ...
                ILOG_DEBUG("got Routing_Error %d", routing.error_reason);
                                                       ...
                                                       void TFTView_320x240::scanSignal(uint32_t scanNo)
                                                       {
                                                           if (scans == 1 && spinnerButton) {
                                                               ...
                                                               uint8_t ch = (uint8_t)(unsigned long)currentPanel->user_data;
                                                               requestId = requests.addRequest(
                                                                   to, ResponseHandler::PositionRequest, (void *)to);
                                                               controller->requestPosition(to, ch, requestId);
                                                               objects.signal_scanner_panel->user_data = (void *)requestId;
                                                           }
                                                       }

                                                       void TFTView_320x240::handlePositionResponse(
                                                           uint32_t from, uint32_t request_id, int32_t rx_rssi, float rx_snr,
                                                           bool isNeighbor)
                                                       {
                                                           if (request_id ==
                                                               (unsigned long)objects.signal_scanner_panel->user_data) {
                ...
                lv_label_set_text(objects.signal_scanner_start_label, buf);
                                                               ...
                                                               ILOG_DEBUG("handlePositionResponse: drop reply with not matching "
                                                                          "request 0x%08x",
                                                                          request_id);
                                                           }
                                                       }
                                                        ...
                                                        */
                                                       void TFTView_320x240::handleTraceRouteResponse(
                                                           const meshtastic_Routing &routing)
                                                       {
                ...
                lv_obj_set_style_outline_color(objects.trace_route_start_button, lv_color_hex(0xDBD251),
                                               LV_PART_MAIN | LV_STATE_DEFAULT);
                                                       ...
                                                       void TFTView_320x240::handleResponse(
                                                           uint32_t from, uint32_t id, const meshtastic_RouteDiscovery &route)
                                                       {
                                                           ILOG_DEBUG("handleResponse: trace route has %d / %d hops",
                                                                      route.route_count, route.route_back_count);
                                                           ...
                                                           if (id && requests.findRequest(id).type ==
                                                                         ResponseHandler::TraceRouteRequest) {
                                                               requests.removeRequest(id);
                                                           }

                                                           for (int i = route.route_count; i > 0; i--) {
                                                               addNodeToTraceRoute(route.route[i - 1],
                                                                                   objects.route_towards_panel);
                                                           }
                                                                                                 ...
                                                                                                 lv_obj_t * panel)
                                                       {
                                                           ...
                                                           lv_obj_set_style_align(btn, LV_ALIGN_TOP_MID,
                                                                                  LV_PART_MAIN | LV_STATE_DEFAULT);
                                                           ...
                                                           lv_obj_set_style_border_color(btn, lv_color_hex(0xff808080),
                                                                                         LV_PART_MAIN | LV_STATE_DEFAULT);
                                                           {
                                                               {
                lv_obj_t *img = lv_img_create(btn);
                if (nodePanel) {
                    setNodeImage(nodeNum, (MeshtasticView::eRole)(unsigned long)nodePanel->LV_OBJ_IDX(node_img_idx)->user_data,
                                 false, img);
                } else {
                ...
                lv_obj_set_style_text_align(label, LV_TEXT_ALIGN_LEFT, LV_PART_MAIN | LV_STATE_DEFAULT);
                                                       ...
                                                       void TFTView_320x240::purgeNode(void)
                                                       {
                                                           ...
                                                           for (auto &it : nodes) {
                                                               time_t lastHeard =
                                                                   (time_t)it.second->LV_OBJ_IDX(node_lh_idx)->user_data;
                                                               if (lastHeard > 0 && lastHeard < oldestTime &&
                                                                   it.first != ownNode) {
                ...
                if (it.first != ownNode) {
                    ...
                    p = it.second;
                                                           ...
                                                           time(&curtime);
                                                           uint32_t lastHeard =
                                                               (unsigned long)p->LV_OBJ_IDX(node_lh_idx)->user_data;
                ...
                lv_obj_delete(it->second);
                                                        ...
                                                        *
                                                        * @param nodeNum
                                                        * @param reset : set true when filter has changed (to recalculate number
                                                        * of filtered nodes)
                                                        * @return true
                                                        * @return false
                                                        */
                                                       bool TFTView_320x240::applyNodesFilter(uint32_t nodeNum, bool reset)
                                                       {
                                                           ...
                                                           if (nodeNum != ownNode /* && filter.active*/) { // TODO
                                                               if (lv_obj_has_state(objects.nodes_filter_unknown_switch,
                                                                                    LV_STATE_CHECKED)) {
                if (lv_img_get_src(panel->LV_OBJ_IDX(node_img_idx)) == &img_circle_question_image) {
                    hide = true;
                }
                                                               }
                                                               if (lv_obj_has_state(objects.nodes_filter_offline_switch,
                                                                                    LV_STATE_CHECKED)) {
                ...
                if (lastHeard == 0 || curtime - lastHeard > secs_until_offline)
                    hide = true;
                                                               ...
                                                               if (lv_obj_has_state(objects.nodes_filter_public_key_switch,
                                                                                    LV_STATE_CHECKED)) {
                lv_color_t color1 = lv_obj_get_style_bg_color(panel->LV_OBJ_IDX(node_img_idx), LV_PART_MAIN | LV_STATE_DEFAULT);
                lv_color_t color2 =
                    lv_obj_get_style_border_color(panel->LV_OBJ_IDX(node_img_idx), LV_PART_MAIN | LV_STATE_DEFAULT);
                bool hasKey = color1.blue == color2.blue && color1.red == color2.red && color1.green == color2.green;
                if (!hasKey)
                    hide = true;
                                                               }
                                                               if (lv_dropdown_get_selected(objects.nodes_filter_hops_dropdown) !=
                                                                   0) {
            ...
            if (viaMqtt)
...
#endif
                                                               if (lv_obj_has_state(objects.nodes_filter_position_switch,
                                                                                    LV_STATE_CHECKED)) {
                ...
                nodesFiltered++;
                                                           ...
                                                           if (true /*highlight.active*/) { // TODO
                                                               if (lv_obj_has_state(objects.nodes_hl_active_chat_switch,
                                                                                    LV_STATE_CHECKED)) {
                ...
                if (it != nodes.end()) {
                    ...
                    highlight = true;
                                                               ...
                                                               if (lv_obj_has_state(objects.nodes_hl_position_switch,
                                                                                    LV_STATE_CHECKED)) {
                if (lv_label_get_text(panel->LV_OBJ_IDX(node_pos1_idx))[0] != '\0') {
                    ...
                    highlight = true;
                                                               ...
                                                               if (lv_obj_has_state(objects.nodes_hl_telemetry_switch,
                                                                                    LV_STATE_CHECKED)) {
                if (lv_label_get_text(panel->LV_OBJ_IDX(node_tm1_idx))[0] != '\0') {
                    ...
                    highlight = true;
                                                               ...
                                                               if (lv_obj_has_state(objects.nodes_hliaq_switch,
                                                                                    LV_STATE_CHECKED)) {
                ...
                if (strcasestr(lv_label_get_text(panel->LV_OBJ_IDX(node_lbl_idx)), name) ||
                    ...
                    highlight = true;
                                                           ...
                                                           if (!highlight) {
                                                               lv_obj_set_style_border_color(panel, lv_color_hex(0x808080),
                                                                                             LV_PART_MAIN | LV_STATE_DEFAULT);
                                                        ...
                                                        * @param ack
                                                        */
                                                       void TFTView_320x240::handleTextMessageResponse(
                                                           uint32_t channelOrNode, const uint32_t id, bool ack)
                                                       {
                                                           ...
                                                           if (!msgContainer) {
                                                               ILOG_WARN("received unexpected response nodeNum/channel 0x%08x "
                                                                         "for request id 0x%08x",
                                                                         channelOrNode, id);
                                                               return;
                                                           }
                ...
                break;
                                                       ...
                                                       void TFTView_320x240::notifyResync(bool show)
                                                       {
                                                           ...
                                                           if (!show) {
                                                               lv_screen_load_anim(objects.main_screen, LV_SCR_LOAD_ANIM_NONE, 0,
                                                                                   0, false);
                                                           }
                                                       }
                                                       ...
                                                       {
                                                           if (enable)
                                                               lv_screen_load_anim(objects.blank_screen,
                                                                                   LV_SCR_LOAD_ANIM_FADE_OUT, 1000, 0, false);
                                                           else {
                ...
                lv_screen_load_anim(objects.boot_screen, LV_SCR_LOAD_ANIM_NONE, 0, 0, false);
                                                       ...
                                                       {
                                                           if (enabled) {
                                                               // overlay main screen with blank screen to prevent accidentally
                                                               // pressing buttons
                                                               lv_screen_load_anim(objects.blank_screen,
                                                                                   LV_SCR_LOAD_ANIM_FADE_OUT, 0, 0, false);
                                                           } else {
                                                           }
                                                           else
                                                           {
                ...
                lv_screen_load_anim(objects.boot_screen, LV_SCR_LOAD_ANIM_NONE, 0, 0, false);
                                                       ...
                                                       {
                                                           static lv_obj_t *btn[c_max_channels] = {
                                                               objects.channel_button0, objects.channel_button1,
                                                               objects.channel_button2, objects.channel_button3,
                                                               objects.channel_button4, objects.channel_button5,
                ...
                lv_label_set_text(channel[ch.index], ch.settings.name);
                                                               ...
                                                               lv_obj_set_style_pad_left(btn[ch.index], 8,
                                                                                         LV_PART_MAIN | LV_STATE_DEFAULT);
                ...
                lv_obj_delete(lv_obj_get_child(btn[ch.index], 1));
                                                       ...
                                                       void TFTView_320x240::updateDeviceConfig(
                                                           const meshtastic_Config_DeviceConfig &cfg)
                                                       {
                                                           ...
                                                           lv_dropdown_set_selected(objects.settings_device_role_dropdown,
                                                                                    cfg.role);
                                                           lv_dropdown_get_selected_str(objects.settings_device_role_dropdown,
                                                                                        buf1, sizeof(buf1));
                                                           lv_snprintf(buf2, sizeof(buf2), _("Device Role: %s"), buf1);
                                                           lv_label_set_text(objects.basic_settings_role_label, buf2);
                                                       }

                                                       void TFTView_320x240::updatePositionConfig(
                                                           const meshtastic_Config_PositionConfig &cfg)
                                                       {
                                                           db.config.position = cfg;
                                                           db.config.has_position = true;
                                                           Themes::recolorButton(
                                                               objects.home_location_button,
                                                               cfg.gps_mode == meshtastic_Config_PositionConfig_GpsMode_ENABLED);
                                                           Themes::recolorText(
                                                               objects.home_location_label,
                                                               cfg.gps_mode == meshtastic_Config_PositionConfig_GpsMode_ENABLED);
                                                       }

                                                       void TFTView_320x240::updatePowerConfig(
                                                           const meshtastic_Config_PowerConfig &cfg)
                                                       {
                                                           db.config.power = cfg;
                                                           db.config.has_power = true;
                                                       }

                                                       void TFTView_320x240::updateNetworkConfig(
                                                           const meshtastic_Config_NetworkConfig &cfg)
                                                       {
                                                           ...
                                                           char buf[40];
                                                           lv_snprintf(buf, sizeof(buf), _("WiFi: %s"),
                                                                       cfg.wifi_ssid[0] ? cfg.wifi_ssid : _("<not set>"));
                                                           lv_label_set_text(objects.basic_settings_wifi_label, buf);
                                                       }

                                                       void TFTView_320x240::updateDisplayConfig(
                                                       ...
                                                       void TFTView_320x240::updateLoRaConfig(
                                                           const meshtastic_Config_LoRaConfig &cfg)
                                                       {
                                                           db.config.lora = cfg;
                                                           ...
                                                           char region[30];
                                                           lv_snprintf(region, sizeof(region), _("Region: %s"),
                                                                       LoRaPresets::loRaRegionToString(cfg.region));
                                                           ...
                                                           lv_dropdown_set_selected(objects.settings_modem_preset_dropdown,
                                                                                    cfg.modem_preset);
                                                           lv_dropdown_get_selected_str(objects.settings_modem_preset_dropdown,
                                                                                        buf1, sizeof(buf1));
                                                           lv_snprintf(buf2, sizeof(buf2), _("Modem Preset: %s"), buf1);
                                                           lv_label_set_text(objects.basic_settings_modem_preset_label, buf2);

                                                           uint32_t numChannels =
                                                               LoRaPresets::getNumChannels(cfg.region, cfg.modem_preset);
                                                           lv_slider_set_range(objects.frequency_slot_slider, 1, numChannels);

                                                           if (!db.config.lora.channel_num) {
                                                               db.config.lora.channel_num = LoRaPresets::getDefaultSlot(
                                                                   db.config.lora.region, THIS->db.config.lora.modem_preset);
                                                           }
                                                           lv_slider_set_value(objects.frequency_slot_slider,
                                                                               db.config.lora.channel_num, LV_ANIM_OFF);
                                                       }

                                                       void TFTView_320x240::showLoRaFrequency(
                                                           const meshtastic_Config_LoRaConfig &cfg)
                                                       {
                                                           char loraFreq[48];
                                                           float frequency = LoRaPresets::getRadioFreq(
                                                               cfg.region, cfg.modem_preset, cfg.channel_num);
                                                       ...
                                                       void TFTView_320x240::updateBluetoothConfig(
                                                       ...
                                                       void TFTView_320x240::updateSecurityConfig(
                                                           const meshtastic_Config_SecurityConfig &cfg)
                                                       {
                                                           db.config.security = cfg;
                                                           db.config.has_security = true;
                                                       }

                                                       void TFTView_320x240::updateSessionKeyConfig(
                                                           const meshtastic_Config_SessionkeyConfig &cfg)
                                                       {
                                                           // TODO
                                                       }
                                                       ...
                                                       void TFTView_320x240::updateMQTTModule(
                                                       ...
                                                       void TFTView_320x240::updateExtNotificationModule(
                                                           const meshtastic_ModuleConfig_ExternalNotificationConfig &cfg)
                                                       {
                                                           ...
                                                           char buf[32];
                                                           lv_snprintf(
                                                               buf, sizeof(buf), _("Message Alert: %s"),
                                                               db.module_config.external_notification.alert_message_buzzer &&
                ...
                break;
                                                           ...
                                                           //    lv_snprintf(buf, sizeof(buf), _("Message Alert: %s"),
                                                           //        db.module_config.external_notification.alert_message_buzzer ?
                                                           //        (rtIndex == 0 ? _("silent") : ringtone[rtIndex].name) :
                                                           //        "off");
                                                           //    lv_label_set_text(objects.basic_settings_alert_label, buf);
                                                           //    char buf[32];
                                                           //    lv_snprintf(buf, sizeof(buf), _("Message Alert: %s"),
                                                       ...
                                                       /**
                                                        * @brief Create a new container for a node or group channel if it does not
                                                        * exist
                                                        *
                                                        * @param from
                                                        ...
                                                        * @param channel
                                                        */
                                                       lv_obj_t *TFTView_320x240::newMessageContainer(uint32_t from, uint32_t to,
                                                                                                      uint8_t ch)
                                                       {
                ...
                return messages[from];
                                                           ...
                                                           lv_obj_set_style_pad_left(container, 6,
                                                                                     LV_PART_MAIN | LV_STATE_DEFAULT);
                                                           lv_obj_set_style_pad_right(container, 6,
                                                                                      LV_PART_MAIN | LV_STATE_DEFAULT);
                                                           lv_obj_set_style_pad_top(container, 0,
                                                                                    LV_PART_MAIN | LV_STATE_DEFAULT);
                                                           lv_obj_set_style_pad_bottom(container, 0,
                                                                                       LV_PART_MAIN | LV_STATE_DEFAULT);
                                                           lv_obj_set_style_pad_row(container, 6,
                                                                                    LV_PART_MAIN | LV_STATE_DEFAULT);
                                                           lv_obj_set_style_pad_column(container, 0,
                                                                                       LV_PART_MAIN | LV_STATE_DEFAULT);
                                                       ...
                                                       /**
                                                        * @brief insert a mew message that arrived into a <channel group> or <from
                                                        * node> container
                                                        *
                                                        * @param nodeNum
                                                        * @param ch
                                                        * @param msg
                                                        */
                                                       void TFTView_320x240::newMessage(uint32_t from, uint32_t to, uint8_t ch,
                                                                                        const char *msg)
                                                       {
                                                           ...
                                                           if (to == UINT32_MAX) { // message for group, prepend short name to msg
                                                               ...
                                                               char *userData =
                                                                   (char *)&(nodes[from]->LV_OBJ_IDX(node_lbs_idx)->user_data);
                                                               int pos = 0;
                ...
                buf[pos++] = ':';
                                                           ...
                                                           if (container != activeMsgContainer ||
                                                               activePanel != objects.messages_panel) {
                                                               unreadMessages++;
                                                               updateUnreadMessages();
                                                               if (activePanel != objects.messages_panel &&
                                                                   db.uiConfig.alert_enabled) {
                showMessagePopup(from, to, ch, lv_label_get_text(nodes[from]->LV_OBJ_IDX(node_lbl_idx)));
                                                        ...
                                                        * @param msg
                                                        */
                                                       void TFTView_320x240::newMessage(uint32_t nodeNum, lv_obj_t * container,
                                                                                        uint8_t ch, const char *msg)
                                                       {
                                                           ...
                                                           lv_coord_t width =
                                                               lv_txt_get_width(msg, strlen(msg), &ui_font_montserrat_12, 0);
                                                           lv_obj_set_width(
                                                               msgLabel, std::max<int32_t>(
                                                                             std::min<int32_t>((int32_t)(width) + 20, 200), 40));
                                                       ...
                                                       void TFTView_320x240::addChat(uint32_t from, uint32_t to, uint8_t ch)
                                                       {
                                                           ...
                                                           lv_obj_set_style_align(chatBtn, LV_ALIGN_TOP_MID,
                                                                                  LV_PART_MAIN | LV_STATE_DEFAULT);
                                                           lv_obj_set_style_border_color(chatBtn, lv_color_hex(0x808080),
                                                                                         LV_PART_MAIN | LV_STATE_DEFAULT);
                                                           lv_obj_set_style_border_width(chatBtn, 1,
                                                                                         LV_PART_MAIN | LV_STATE_DEFAULT);
                                                           lv_obj_set_style_shadow_ofs_x(chatBtn, 1,
                                                                                         LV_PART_MAIN | LV_STATE_DEFAULT);
                                                           lv_obj_set_style_shadow_ofs_y(chatBtn, 2,
                                                                                         LV_PART_MAIN | LV_STATE_DEFAULT);
                                                           ...
                                                           if (to == UINT32_MAX || from == 0) {
                                                               ...
                                                               sprintf(buf, "%s: %s",
                                                                       lv_label_get_text(nodes[from]->LV_OBJ_IDX(node_lbs_idx)),
                ...
                lv_obj_add_flag(obj, LV_OBJ_FLAG_HIDDEN);
                {
                    lv_obj_t *parent_obj = obj;
                    {
                        ...
                        lv_obj_set_style_align(chatDelBtn, LV_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
                                                           ...
                                                           lv_obj_add_event_cb(chatBtn, ui_event_ChatButton, LV_EVENT_ALL,
                                                                               (void *)index);
                                                           lv_obj_add_event_cb(chatDelBtn, ui_event_ChatDelButton,
                                                       ...
                                                       void TFTView_320x240::highlightChat(uint32_t from, uint32_t to, uint8_t ch)
                                                       {
                                                           ...
                                                           if (it != chats.end()) {
                                                               // mark chat in color
                                                               lv_obj_set_style_border_color(it->second, lv_color_hex(0xFF8C04),
                                                                                             LV_PART_MAIN | LV_STATE_DEFAULT);
                                                           }
                                                       }
                                                        ...
                                                        */
                                                       void TFTView_320x240::showMessagePopup(uint32_t from, uint32_t to,
                ...
                lv_disp_trig_activity(NULL);
                                                       ...
                                                       void TFTView_320x240::showMessages(uint8_t ch)
                                                       {
                                                           ...
                                                           lv_label_set_text(objects.top_group_chat_label,
                                                                             lv_label_get_text(channel[ch]));
                                                           ui_set_active(objects.messages_button, objects.messages_panel,
                                                       ...
                                                       void TFTView_320x240::showMessages(uint32_t nodeNum)
                                                       {
                                                           ...
                                                           if (p) {
                                                               lv_label_set_text(objects.top_messages_node_label,
                                                                                 lv_label_get_text(p->LV_OBJ_IDX(node_lbl_idx)));
                                                               ui_set_active(objects.messages_button, objects.messages_panel,
                                                                             objects.top_messages_panel);
                                                               lv_color_t color1 = lv_obj_get_style_bg_color(
                                                                   p->LV_OBJ_IDX(node_img_idx), LV_PART_MAIN | LV_STATE_DEFAULT);
                                                               lv_color_t color2 = lv_obj_get_style_border_color(
                                                                   p->LV_OBJ_IDX(node_img_idx), LV_PART_MAIN | LV_STATE_DEFAULT);
                                                               bool hasKey = color1.blue == color2.blue &&
                ...
                lv_obj_set_style_bg_image_src(objects.top_messages_node_image, &img_lock_channel_image,
                                              LV_PART_MAIN | LV_STATE_DEFAULT);
                                                       ...
                                                       /**
                                                        * @brief Place keyboard at a suitable space above or below the text input
                                                        * area
                                                        *
                                                        * @param textArea
                                                        */
                                                       void TFTView_320x240::showKeyboard(lv_obj_t * textArea)
                                                       {
                                                           ...
                                                           uint32_t v =
                                                               lv_display_get_vertical_resolution(displaydriver->getDisplay());
                                                       ...
                                                       void TFTView_320x240::enablePanel(lv_obj_t * panel)
                                                       {
                                                           ...
                                                           auto enableButtons = [](lv_obj_t *obj,
                                                                                   void *) -> lv_obj_tree_walk_res_t {
                                                       ...
                                                       void TFTView_320x240::disablePanel(lv_obj_t * panel)
                                                       {
                                                           ...
                                                           auto disableButtons = [](lv_obj_t *obj,
                                                                                    void *) -> lv_obj_tree_walk_res_t {
                                                               if (obj->class_p == &lv_button_class) {
                ...
                if (panel->spec_attr->children[i]->class_p == &lv_button_class) {
                    ...
                    break;
                                                       ...
                                                       void TFTView_320x240::setInputButtonLabel(void)
                                                       {
                                                           ...
                                                           char label[40];
                                                           lv_snprintf(label, sizeof(label), _("Input Control: %s/%s"),
                                                                       current_ptr.c_str(), current_kbd.c_str());
                                                       ...
                                                       void TFTView_320x240::setNodeImage(uint32_t nodeNum, eRole role,
                                                                                          bool viaMqtt, lv_obj_t *img)
                                                       {
                                                           uint32_t bgColor, fgColor;
                                                       ...
                                                       {
                                                           char buf[40];
                                                           lv_snprintf(buf, sizeof(buf), _p("%d of %d nodes online", nodesOnline),
                ...
                lv_snprintf(buf, sizeof(buf), _("Filter: %d of %d nodes"), nodeCount - nodesFiltered, nodeCount);
                                                        ...
                                                        *        Because the update can take quite some time (tens of ms) it is
                                                        * done in smaller chunks of 10 nodes per invocation, so it must be
                                                        * periodically called
                                                        *        TODO: check for side effects if new nodes are inserted during
                                                        * filter processing
                                                        * @param reset indicates to start update from beginning of node list
                                                        * otherwise continue with iterator position or skip if done
                                                        */
                ...
                if (isOnline)
                    online++;
                                                       ...
                                                       void TFTView_320x240::updateUnreadMessages(void)
                                                       {
                                                           ...
                                                           if (unreadMessages > 0) {
                                                               sprintf(buf,
                                                                       unreadMessages == 1 ? _("%d new message")
                                                                                           : _("%d new messages"),
                                                                       unreadMessages);
                                                               lv_obj_set_style_bg_img_src(objects.home_mail_button,
                                                                                           &img_home_mail_unread_button_image,
                                                                                           LV_PART_MAIN | LV_STATE_DEFAULT);
                                                           } else {
                                                       ...
                                                       void TFTView_320x240::updateTime(void)
                                                       {
                                                           ...
                                                           int len = 0;
                                                           if (curr_time > 1000000 &&
                                                               (unsigned long)objects.home_time_button->user_data == 0) {
                                                               ...
                                                               sprintf(&buf[len], _("uptime: %02d:%02d:%02d"), hours, minutes,
                                                                       seconds);
                                                           }
                                                       ...
                                                       {
                                                           // only update if HomePanel is active (since this is some critical code
                                                           // that did crash sporadically)
                                                           if (activePanel == objects.home_panel &&
                                                               (unsigned long)objects.home_memory_button->user_data) {
                                                               char buf[64];
                                                               uint32_t freeHeap = 0;
                                                               ...
                                                               sprintf(buf, _("Heap: %d (%d%%)\nLVGL: %d (%d%%)"), freeHeap,
                                                                       freeHeap_pct, mon.free_size, 100 - mon.used_pct);
                ...
                freeHeap_pct = 100 * freeHeap / totalMem;
                                                               ...
                                                               sprintf(buf, _("Heap: %d (%d%%)\nLVGL: %d (%d%%)"), freeHeap,
                                                                       freeHeap_pct, mon.free_size / 1024, 100 - mon.used_pct);
#else
                                                               buf[0] = '\0';
#endif

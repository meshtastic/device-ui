...
{
    // TODO: select dest/channel
    controller->sendText(UINT32_MAX, 0, msg);
    addMessage(msg);
}
...
void TFTView_320x240::addNode(uint32_t nodeNum, uint8_t channel, const char *userShort, const char *userLong, uint32_t lastHeard,
                              eRole role)
{
...
void TFTView_320x240::addOrUpdateNode(uint32_t nodeNum, uint8_t channel, const char *userShort, const char *userLong,
...
void TFTView_320x240::updateNode(uint32_t nodeNum, uint8_t channel, const char *userShort, const char *userLong,
                                 uint32_t lastHeard, eRole role)
{
...
void TFTView_320x240::newMessage(uint32_t nodeNum, uint8_t channel, const char *msg)
{
    lv_obj_t *hiddenPanel = lv_obj_create(ui_MessagesContainer);
    lv_obj_set_width(hiddenPanel, lv_pct(100));
    ...
    lv_obj_set_width(msgLabel, lv_pct(60));

                                                        ...
                                                        std::shared_ptr<IUICommandDispatcher> commandDispatcher) const
{
    ...
    POLICY_DEBUG("[InputFactory] Adding FocusTraversalPolicy");
    ...
    if (commandDispatcher) {
        POLICY_DEBUG("[InputFactory] Adding CommandDispatchPolicy");
    ...
    POLICY_DEBUG("[InputFactory] Adding PassthroughPolicy as fallback");

...
TFTView_160x80 *TFTView_160x80::instance(void) {
  if (!gui)
    gui = new TFTView_160x80;
  return gui;
}

#ifdef USE_X11
TFTView_160x80::TFTView_160x80()
    : DeviceGUI(&X11Driver::create(), new ViewController) {}
#else
TFTView_160x80::TFTView_160x80()
    : DeviceGUI(new LGFXDriver<LGFX_DRIVER>(screenWidth, screenHeight),
                new ViewController) {}
#endif

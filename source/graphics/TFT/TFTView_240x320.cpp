...
#include "graphics/view/TFT/TFTView_240x320.h"
...
#define THIS TFTView_240x320::instance() // need to use THIS in all static methods

TFTView_240x320 *TFTView_240x320::instance(void)
{
    if (!gui)
        gui = new TFTView_240x320(nullptr, DisplayDriverFactory::create(480, 222));
    return static_cast<TFTView_240x320 *>(gui);
}

TFTView_240x320 *TFTView_240x320::instance(const DisplayDriverConfig &cfg)
{
    if (!gui)
        gui = new TFTView_240x320(&cfg, DisplayDriverFactory::create(cfg));
    return static_cast<TFTView_240x320 *>(gui);
}

TFTView_240x320::TFTView_240x320(const DisplayDriverConfig *cfg, DisplayDriver *driver) : PluggableView(cfg, driver) {}

void TFTView_240x320::init(IClientBase *client)
{
    ILOG_DEBUG("TFTView_240x320 init...");
    PluggableView::init(client);
}

void TFTView_240x320::ui_events_init(void)
{
 ...
 */
bool TFTView_240x320::setupUIConfig(const meshtastic_DeviceUIConfig &uiconfig)
{
 ...
 *
 */
void TFTView_240x320::init_screens(void)
{
...
void TFTView_240x320::ui_init(void)
{
    PluggableView::ui_init();
}

lv_obj_t *TFTView_240x320::createAddMessageWidget(lv_obj_t *parent, uint32_t msgTime, uint32_t requestId, const char *msg)
{
...
lv_obj_t *TFTView_240x320::createNewMessageWidget(lv_obj_t *parent, uint32_t msgTime, uint32_t nodeNum, uint8_t channel,
                                                  const char *msg)
{
...
lv_obj_t *TFTView_240x320::createChatWidget(lv_obj_t *parent, uint32_t index)
{
...
lv_obj_t *TFTView_240x320::createMessageContainerWidget(lv_obj_t *parent)
{
...
void TFTView_240x320::task_handler(void)
{

...
{
    if (!gui)
        gui = new TFTView_320x170(nullptr, DisplayDriverFactory::create(480, 222));
    return static_cast<TFTView_320x170 *>(gui);
}
...
TFTView_320x170::TFTView_320x170(const DisplayDriverConfig *cfg, DisplayDriver *driver) : PluggableView(cfg, driver) {}
...
lv_obj_t *TFTView_320x170::createAddMessageWidget(lv_obj_t *parent, uint32_t msgTime, uint32_t requestId, const char *msg)
{
...
lv_obj_t *TFTView_320x170::createNewMessageWidget(lv_obj_t *parent, uint32_t msgTime, uint32_t nodeNum, uint8_t channel,
                                                  const char *msg)
{
...
lv_obj_t *TFTView_320x170::createChatWidget(lv_obj_t *parent, uint32_t index)
{
...
lv_obj_t *TFTView_320x170::createMessageContainerWidget(lv_obj_t *parent)
{

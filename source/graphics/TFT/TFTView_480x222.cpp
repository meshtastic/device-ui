...
void TFTView_480x222::ui_events_init(void)
{
    ...
    // Register back key callback: focus home button when backspace pressed outside a text field
...
void TFTView_480x222::ui_event_message_ready(lv_event_t *e)
{
    ...
    if (event_code == LV_EVENT_READY) {
        ...
        // Scroll when textarea is empty; otherwise let textarea handle cursor movement
